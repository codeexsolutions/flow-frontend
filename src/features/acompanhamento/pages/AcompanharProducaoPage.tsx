            ...
            {wallpaper && (
                <>
                    <div
                        ...
                        style={{ backgroundImage: `url("${wallpaper}")`, opacity: p.escuro ? 0.18 : 0.14 }}
                    />
                    {/* O degradê tira a imagem de baixo do conteúdo denso e a
                        deixa respirar no topo, onde só existe a marca. */}
                    <div
                        className="fixed inset-0 -z-10"
                        style={{ background: `linear-gradient(to bottom, ${rgba(p.fundo, 0.2)} 0%, ${rgba(p.fundo, 0.8)} 55%, ${p.fundo} 100%)` }}
                    />
                </>
            )}
        </>
        ...
        <div className="min-h-[100dvh]">
            ...
            <header className="relative overflow-hidden" style={{ background: p.capa, color: p.sobreCapa }}>
                {faixa && (
                    ...
                    <div
                        ...
                        style={{ backgroundImage: `url("${faixa}")`, opacity: 0.3 }}
                    />
                )}

                <div
                    className="absolute inset-0"
                    style={{ background: `linear-gradient(to bottom, ${rgba("#000000", 0.04)}, ${rgba("#000000", 0.2)})` }}
                />
            ...
            <main className="mx-auto w-full max-w-3xl px-4 pb-10 sm:px-6">
                ...
                <motion.div
                    ...
                    className="relative -mt-9 mb-5 rounded-3xl px-5 py-4 shadow-lg sm:-mt-10"
                    style={{ backgroundColor: p.cartao, border: `1px solid ${p.linha}` }}
                >
                    <div className="flex items-center gap-3">
                        ...
                        <span
                            ...
                            style={{ backgroundColor: rgba(atualizando ? p.destaque : VERDE, 0.12), color: atualizando ? p.destaque : VERDE }}
                            title="Esta página se atualiza sozinha"
                        >
                            <motion.span
                                animate={{ opacity: [1, 0.25, 1] }}
                                transition={{ duration: atualizando ? 0.7 : 2.2, repeat: Infinity, ease: "easeInOut" }}
                                className="h-1.5 w-1.5 rounded-full"
                                style={{ backgroundColor: atualizando ? p.destaque : VERDE }}
                            />
                                        ...
                                        <div className="px-4 pt-4 sm:px-5">
                                            ...
                                            >
                                                ...
                                                <span
                                                    ...
                                                    style={{ background: `linear-gradient(to top, ${rgba("#000000", 0.6)}, transparent)` }}
                                                />

                                                <span className="absolute bottom-3 left-3.5 text-[10px] font-bold uppercase tracking-[0.14em] text-white/85">
                                                    {colunas[guia].nome}
                                                </span>
                                                ...
                                                {dados.linhas.length > 1 && (
                                                    <span className="absolute left-3 top-3 rounded-full bg-black/45 px-2.5 py-1 text-[10.5px] font-semibold text-white backdrop-blur-sm">
                                                        Pedido {n + 1}
                                                    </span>
                                                )}
                                            </button>
                                        ...
                                        <div className="px-4 pt-4 sm:px-5">
                                            <div className="mb-2 flex items-center justify-between">
                                                ...
                                                <span
                                                    ...
                                                    style={{ color: concluido ? VERDE : p.destaque }}
                                                >
                                            ...
                                            <div className="h-1.5 overflow-hidden rounded-full" style={{ backgroundColor: rgba(p.destaque, 0.14) }}>
                                                <motion.div
                                                    ...
                                                    style={{ backgroundColor: concluido ? VERDE : p.destaque }}
                                                />
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {prazo && prazoValor && iPrazo != null && (
                                        <div className="px-4 pt-3 sm:px-5">
                                            <div
                                                ...
                                                style={{ backgroundColor: rgba(prazo.cor, 0.11), border: `1px solid ${rgba(prazo.cor, 0.24)}` }}
                                            >
                                                <span
                                                    className="grid h-8 w-8 shrink-0 place-items-center rounded-xl"
                                                    style={{ backgroundColor: rgba(prazo.cor, 0.16), color: prazo.cor }}
                                                >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <p
                                                        className="truncate text-[9.5px] font-bold uppercase tracking-[0.14em]"
                                                        style={{ color: rgba(prazo.cor, 0.85) }}
                                                    >
                                                        {colunas[iPrazo].nome}
                                                    </p>
                ...
                {ampliada && (
                    ...
                    >
                        ...
                        <a
                            ...
                            className="absolute left-4 top-4 flex items-center gap-1.5 rounded-full bg-white/10 px-3.5 py-2.5 text-[12px] font-medium text-white backdrop-blur transition hover:bg-white/20"
                        >
                            <Paperclip size={13} />
                            Abrir anexo
                        </a>
